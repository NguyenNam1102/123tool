...
$base_url = 'https://123tool.pro/'; // Thay url web bạn
class SENPAI
{
    private $ketnoi;
    function connect()
    {
        if (!$this->ketnoi)
        {
            $this->ketnoi = mysqli_connect('localhost', 'toolshop_tranvlnh', 'nhatloc20t', 'toolshop_activekey') or die ('Vui lòng kết nối đến DATABASE');
