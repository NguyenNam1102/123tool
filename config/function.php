<?php
$NNL = new SENPAI;
$MEMO_PREFIX        = $NNL->site('noidung_naptien');
$site_gmail_momo    = $NNL->site('email');
$site_pass_momo     = $NNL->site('pass_email');
$api_key=$NNL->site('api_key');
$token=$NNL->site('token');
$ck_the=$NNL->site('ck_con');
$km_momo=$NNL->site('ck_bank');
$km_tsr=$NNL->site('ck_tsr');
$partner_id = $NNL->site('partnerid');
$partner_key =$NNL->site('partnerkey');
